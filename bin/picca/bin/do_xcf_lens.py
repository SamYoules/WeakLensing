...
from picca import constants, xcf, io_lens, prep_del_lens, utils
from picca.data_lens import forest
...
if __name__ == '__main__':
    ...
    if not args.no_remove_mean_lambda_obs:
        ...
        ll,st, wst   = prep_del_lens.stack(xcf.dels,delta=True)
        for p in xcf.dels:
            for d in xcf.dels[p]:
    ...
    ### Read objects
    objs,zmin_obj = io_lens.read_objects(args.drq, args.nside, args.z_min_obj, args.z_max_obj,\
