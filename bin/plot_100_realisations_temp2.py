...
##- Open kappa true-correlation and input files
...
kxi_input = hp.ud_grade(kinput, NSIDE)
...
ax2 = P.subplot(gs[1, 1]) # row 2, col 0
...
P.savefig('plots/100_square.pdf', bbox_inches='tight')
