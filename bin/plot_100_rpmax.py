...
## Plots cross-cf error bars for input and estimated kappa, for different values of rp_max.
...
Clxi = ['maps/midpoint/true_corr/Cls/Cl_crosses_xnoisy_rp30.txt', 'maps/midpoint/true_corr/Cls/Cl_crosses_xnoisy_rp70.txt', 'maps/midpoint/true_corr/Cls/Cl_crosses_xnoisy_rt100.txt', 'maps/midpoint/true_corr/Cls/Cl_crosses_xnoisy_rp150.txt']
...
Clx = ['maps/midpoint/xnoisyrp30/Cls/Cl_crosses.txt', 'maps/midpoint/xnoisyrp70/Cls/Cl_crosses.txt', 'maps/midpoint/xnoisy100/Cls/Cl_crosses.txt', 'maps/midpoint/xnoisyrp150/Cls/Cl_crosses.txt']
...
P.errorbar(ell, cross_mean[0]*ell, xerr=None, yerr=cross_stdev[0]*ell, color=colors[0], marker = 'o', fmt='.', capsize=5, elinewidth=2, markeredgewidth=2, markeredgecolor=colors[0], label='rp_max = 30')
P.errorbar(ell + 5, cross_mean[1]*ell, xerr=None, yerr=cross_stdev[1]*ell, color=colors[1], marker = 'o', fmt='.', capsize=5, elinewidth=2, markeredgewidth=2, markeredgecolor=colors[1], label='rp_max = 70')
P.errorbar(ell + 10, cross_mean[2]*ell, xerr=None, yerr=cross_stdev[2]*ell, color=colors[2], marker = 'o', fmt='.', capsize=5, elinewidth=2, markeredgewidth=2, markeredgecolor=colors[2], label='rp_max = 100')
P.errorbar(ell + 15, cross_mean[3]*ell, xerr=None, yerr=cross_stdev[3]*ell, color=colors[3], marker = 'o', fmt='.', capsize=5, elinewidth=2, markeredgewidth=2, markeredgecolor=colors[3], label='rp_max = 150')
...
P.tight_layout()
P.savefig('plots/compare_rpmax_xnoisy.pdf')
