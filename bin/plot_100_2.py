...
Clx = ['maps/midpoint/{}/Cls/Cl_crosses.txt'.format(maptype), '../desi_old/Cls/Cl_crosses_{}.txt'.format(maptype)]
Cli = ['maps/input/Cl_inputs.txt', '../desi_old/Cls/Cl_inputs_{}.txt'.format(maptype)]
...
P.errorbar(ell, cross_mean[0]*ell, xerr=None, yerr=cross_stdev[0]*ell, color=colors[0], marker = 'o', fmt='.', capsize=5, elinewidth=2, markeredgewidth=2, markeredgecolor=colors[0], label='New {} Est x Input'.format(mapname))
P.errorbar(ell + 4, cross_mean[1]*ell, xerr=None, yerr=cross_stdev[1]*ell, color=colors[1], marker = 'o', fmt='.', capsize=5, elinewidth=2, markeredgewidth=2, markeredgecolor=colors[1], label='Old {} Est x Input'.format(mapname))
