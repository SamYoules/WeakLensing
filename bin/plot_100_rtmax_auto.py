...
#Clxi = ['maps/midpoint/true_corr/Cls/Cl_crosses_noisy_rt30.txt', 'maps/midpoint/true_corr/Cls/Cl_crosses_noisy_rt70.txt', 'maps/midpoint/true_corr/Cls/Cl_crosses_noisy_rt100.txt']
Clxi = ['maps/midpoint/true_corr/Cls/Cl_crosses_noisy_rt30.txt', 'maps/midpoint/true_corr/Cls/Cl_crosses_noisy_rt70.txt']
...
#Clx = ['maps/midpoint/noisy30/Cls/Cl_crosses.txt', 'maps/midpoint/noisy/Cls/Cl_crosses.txt', 'maps/midpoint/noisy100/Cls/Cl_crosses.txt']
Clx = ['maps/midpoint/noisy30/Cls/Cl_crosses.txt', 'maps/midpoint/noisy/Cls/Cl_crosses.txt']
...
P.tight_layout()
P.savefig('plots/compare_rtmax_noisy.pdf')
